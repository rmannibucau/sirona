...
public class AgentContextTest
{
    ...
    {
        final Class<?> clazz = new AgentContext( "com.github.rmannibucau.sirona.javaagent.listener.AgentContextTest.keyClass()", //
                                                 this, //
    ...
    {
        final Method mtd = new AgentContext( "com.github.rmannibucau.sirona.javaagent.listener.AgentContextTest.keyMethod()", //
                                             this, //
                                             new InvocationListener[0], //
                                             null ) //
            .keyAsMethod();
    ...
    {
        //com.github.rmannibucau.test.sirona.javaagent.App.foo()
        Assert.assertEquals( "com.github.rmannibucau.test.sirona.javaagent.App", //
                             PathTrackingListener.extractClassName( "com.github.rmannibucau.test.sirona.javaagent.App.foo()" ) );

        Assert.assertEquals( "com.github.rmannibucau.test.sirona.javaagent.App", //
                             PathTrackingListener.extractClassName(
                                 "com.github.rmannibucau.test.sirona.javaagent.App.pub(java.lang.String)" ) );
        ...
        Assert.assertEquals( "foo()", //
                             PathTrackingListener.extractMethodName( "com.github.rmannibucau.test.sirona.javaagent.App.foo()" ) );
