...
import com.github.rmannibucau.sirona.javaagent.spi.InvocationListener;
import com.github.rmannibucau.sirona.pathtracking.PathTrackingEntry;
import com.github.rmannibucau.sirona.pathtracking.PathTrackingInvocationListener;
...
import com.github.rmannibucau.sirona.javaagent.tracking.PathTracker;
...
public class PathTrackingListenerTest
{
    ...
    @AgentArgs( value = "debug=true|sirona.agent.debug=${sirona.agent.debug}",
        sysProps = "project.build.directory=${project.build.directory}|sirona.agent.debug=${sirona.agent.debug}|com.github.rmannibucau.sirona.configuration.sirona.properties=${project.build.directory}/test-classes/pathtracking/sirona.properties|java.io.tmpdir=${project.build.directory}" )
        ...
        throws Exception
    {
        ...
        Assert.assertEquals( "com.github.rmannibucau.test.sirona.javaagent.App", entry.getClassName() );
        ...
        InvocationListener[] listeners =
            AgentContext.listeners( "com.github.rmannibucau.test.sirona.javaagent.App.pub(java.lang.String,java.util.List,int)", //
                                    null );

        mock = findInstance( listeners );

        AgentContext agentContext =
            mock.contextPerKey.get( "com.github.rmannibucau.test.sirona.javaagent.App.pub(java.lang.String,java.util.List,int)" );
