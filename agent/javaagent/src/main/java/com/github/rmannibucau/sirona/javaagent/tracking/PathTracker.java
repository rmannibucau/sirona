...
*/
package com.github.rmannibucau.sirona.javaagent.tracking;
...
import com.github.rmannibucau.sirona.pathtracking.Context;
...
import com.github.rmannibucau.sirona.pathtracking.UniqueIdGenerator;
...
public class PathTracker
{
    private static final String NODE =
        Configuration.getProperty( Configuration.CONFIG_PROPERTY_PREFIX + "javaagent.path.tracking.marker", //
                                   Configuration.getProperty( "com.github.rmannibucau.sirona.cube.CubeBuilder.marker", "node" ) );
