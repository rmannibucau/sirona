...
import com.github.rmannibucau.sirona.javaagent.classloader.LoadFirstClassLoader;
import com.github.rmannibucau.sirona.javaagent.logging.SironaAgentLogging;
...
public class SironaTransformer implements ClassFileTransformer {
    ...
    protected boolean shouldTransform(final String className, final ClassLoader loader) {
        return !(className == null // framework with bug
                ...
                || className.startsWith("com/github/rmannibucau/sirona"));
    }
}
