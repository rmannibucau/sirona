...
import com.github.rmannibucau.sirona.pathtracking.PathTrackingInformation;
import com.github.rmannibucau.sirona.spi.Order;

@Order( 1 )
@AutoSet
/**
 * This listener is responsible to track/record class#method path using {@link com.github.rmannibucau.sirona.javaagent.tracking.PathTracker}
    ...
    extends ConfigurableListener
{
    ...
    /**
     * executed before method called to configure the start {@link com.github.rmannibucau.sirona.pathtracking.PathTrackingInformation}
     * and set various thread local variable as invocation level
     * will call {@link com.github.rmannibucau.sirona.javaagent.tracking.PathTracker#start(PathTrackingInformation, Object)}
     *
     * @param context
     */
    @Override
    ...
    /**
     * will call {@link com.github.rmannibucau.sirona.javaagent.tracking.PathTracker#stop(Object reference)}
     *
     * @param context
     * @param result
     * @param error
