 ...
 */
package com.github.rmannibucau.sirona.javaagent;
...
public class SironaAgent {
    ...
    public static void agentmain(final String agentArgs, final Instrumentation instrumentation) {
        ...
        try { // eager init of static blocks
            Class.forName("com.github.rmannibucau.sirona.configuration.Configuration", true, loader);
            Class.forName("com.github.rmannibucau.sirona.javaagent.AgentContext", true, loader);
        } catch (final Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            Class<?> clazz = Class.forName("com.github.rmannibucau.sirona.javaagent.AgentContext", true, loader);
        ...
        try {
            ...
            final Class<?> listener = loader.loadClass("com.github.rmannibucau.sirona.javaagent.spi.InvocationListener");
    ...
    private static void debug(ClassLoader loader, String msg, Object... objects) {
        try {
            Method method = loader //
                    .loadClass("com.github.rmannibucau.sirona.javaagent.logging.SironaAgentLogging") //
    ...
    private static boolean isDebug(ClassLoader loader) {
        try {
            return Boolean.class.cast(
                    loader.loadClass("com.github.rmannibucau.sirona.javaagent.logging.SironaAgentLogging") //
