 ...
 */
package com.github.rmannibucau.sirona.jdbc;
...
public class SironaDriver implements Driver {
    ...
    } // sexier than Class.forName("com.github.rmannibucau.sirona.jdbc.SironaDriver"); in full java
    ...
    public Logger getParentLogger() throws SQLFeatureNotSupportedException {
        return Logger.getLogger("com.github.rmannibucau.sirona.jdbc.driver");
    }
}
