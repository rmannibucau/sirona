 ...
 */
package com.github.rmannibucau.sirona.agent.jaxrs.jaxrs2;

import com.gargoylesoftware.htmlunit.Page;
import com.gargoylesoftware.htmlunit.WebClient;
import org.apache.catalina.startup.Constants;
import org.apache.cxf.jaxrs.servlet.CXFNonSpringJaxrsServlet;
import com.github.rmannibucau.sirona.agent.jaxrs.jaxrs2.service.SimpleService;
...
public class JAXRS2PerformanceTest {
    ...
    public static Archive<?> war() {
        return ShrinkWrap.create(WebArchive.class, "sirona-jaxrs2.war")
            .addAsWebInfResource(new StringAsset(
                Descriptors.create(WebAppDescriptor.class)
                    ...
                    .createServlet()
                        ...
                        .up()
                        .createInitParam()
                            .paramName("jaxrs.providers").paramValue(SironaFeature.class.getName())
                        .up()
                    .up()
