 ...
 * under the License.
 */
package com.github.rmannibucau.sirona.agent.webapp.pull.servlet;

import com.github.rmannibucau.sirona.agent.webapp.pull.repository.PullRepository;
...
public class PullServlet extends HttpServlet {
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        if (registration != null) { // needs to have configured com.github.rmannibucau.sirona.cube.CubeBuilder in sirona.properties
