...
public interface PathTrackingDataStore
{
     ...
     *
     * @param trackingId
     * @return {@link List} of {@link com.github.rmannibucau.sirona.pathtracking.PathTrackingEntry} related to a tracking id
     */
     ...
     * @param startTime
     * @param endTime
     * @return {@link com.github.rmannibucau.sirona.pathtracking.PathCallInformation} of all trackingIds available in the system between startTime and endTime
     */
