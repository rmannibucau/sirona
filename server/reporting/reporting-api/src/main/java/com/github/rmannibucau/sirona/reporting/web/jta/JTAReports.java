...
package com.github.rmannibucau.sirona.reporting.web.jta;
...
public class JTAReports
{
    ...
    // copied to avoid classloading issue depending on the deployment, see com.github.rmannibucau.sirona.jta.JTAGauges
